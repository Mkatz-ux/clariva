...
const SCIENCE_QS = {
  ...
  light_sound_1:[[{text:"What is sound?",answer:"Vibrations we hear",choices:["Vibrations we hear","A color we see","A smell","A taste"]},{text:"How do you make a sound with a drum?",answer:"Hit it so it vibrates",choices:["Hit it so it vibrates","Paint it","Freeze it","Smell it"]},{text:"Can you hear sound in complete silence?",answer:"No, sound needs vibration",choices:["No, sound needs vibration","Yes, always","Only at night","Only outside"]}],[{text:"Light travels in a ___ line.",answer:"Straight",choices:["Straight","Curvy","Circular","Zigzag"]},{text:"What lets light pass through it easily?",answer:"Clear glass",choices:["Clear glass","A brick wall","A wooden door","A metal pan"]},{text:"Where does sunlight come from?",answer:"The sun",choices:["The sun","The moon","Clouds","Streetlights"]}],[{text:"A mirror ___ light.",answer:"Reflects",choices:["Reflects","Absorbs","Eats","Freezes"]},{text:"What do you see when light bounces off a shiny surface?",answer:"A reflection",choices:["A reflection","A shadow","A sound","A smell"]},{text:"Which object reflects light best?",answer:"A mirror",choices:["A mirror","A pillow","A sock","A cardboard box"]}],[{text:"A flashlight blinking on and off could send a ___.",answer:"Signal",choices:["Signal","Smell","Sound wave","Shadow"]},{text:"Traffic lights use light to tell drivers to ___.",answer:"Stop or go",choices:["Stop or go","Sing","Sleep","Swim"]},{text:"Which uses light to send messages far away?",answer:"A lighthouse",choices:["A lighthouse","A pillow","A rock","A shoe"]}],[{text:"Without light, could you see a reflection in a mirror?",answer:"No",choices:["No","Yes","Only at noon","Only in winter"]},{text:"Sound travels through air by making it ___.",answer:"Vibrate",choices:["Vibrate","Freeze","Disappear","Glow"]},{text:"Which is NOT a source of light?",answer:"A rock",choices:["A rock","The sun","A flashlight","A candle"]}]],
  plants_anim_1:[[{text:"Plants need sunlight, water, and ___ to grow.",answer:"Air",choices:["Air","Candy","Sand","Ice"]},{text:"What do plant roots take in from soil?",answer:"Water",choices:["Water","Rocks","Toys","Paper"]},{text:"Why do plants need sunlight?",answer:"To make food",choices:["To make food","To sleep","To swim","To sing"]}],[{text:"Animals need food, water, and ___ to survive.",answer:"Shelter",choices:["Shelter","Toys","Music","Paint"]},{text:"What do animals get from eating food?",answer:"Energy",choices:["Energy","Colors","Sounds","Shapes"]},{text:"Why do animals need water?",answer:"To stay alive and healthy",choices:["To stay alive and healthy","To fly","To change color","To count"]}],[{text:"Which part of a plant holds it in the ground?",answer:"Roots",choices:["Roots","Leaves","Petals","Stem"]},{text:"Which part of a plant makes food using sunlight?",answer:"Leaves",choices:["Leaves","Roots","Seeds","Bark"]},{text:"What holds the leaves and flowers up?",answer:"The stem",choices:["The stem","The roots","The seed","The soil"]}],[{text:"Fish use ___ to breathe underwater.",answer:"Gills",choices:["Gills","Lungs","Ears","Fur"]},{text:"Birds use their wings to ___.",answer:"Fly",choices:["Fly","Swim","Dig","Chew"]},{text:"What do sharp teeth help an animal do?",answer:"Eat its food",choices:["Eat its food","Hear better","See in the dark","Breathe"]}],[{text:"A trait passed from parent to baby is called ___.",answer:"Inherited",choices:["Inherited","Invented","Painted","Borrowed"]},{text:"Puppies look like their parents because of ___.",answer:"Inherited traits",choices:["Inherited traits","Their toys","The weather","Their food bowl"]},{text:"Which is an inherited trait in animals?",answer:"Fur color",choices:["Fur color","A trick it learned","A scar","Its name"]}]],
  matter_2:[[{text:"A solid has a definite ___.",answer:"Shape",choices:["Shape","Smell","Sound","Color only"]},{text:"Which of these is a solid?",answer:"A rock",choices:["A rock","Juice","Steam","Air"]},{text:"Does a solid change shape when you move it to a new container?",answer:"No",choices:["No","Yes, always","Only if it's cold","Only if it's hot"]}],[{text:"A liquid takes the shape of its ___.",answer:"Container",choices:["Container","Color","Smell","Weight"]},{text:"Which of these is a liquid?",answer:"Milk",choices:["Milk","A book","A chair","Ice cube"]},{text:"Can you pour a liquid?",answer:"Yes",choices:["Yes","No","Only if it's a solid","Only outside"]}],[{text:"What happens to ice when you heat it?",answer:"It melts into water",choices:["It melts into water","It turns to stone","It disappears forever","It gets colder"]},{text:"What happens to water when you freeze it?",answer:"It becomes solid ice",choices:["It becomes solid ice","It becomes gas","It disappears","It turns purple"]},{text:"Heating usually makes a solid ___.",answer:"Melt",choices:["Melt","Freeze","Disappear","Shrink forever"]}],[{text:"When you mix sand and water, can you still see the sand?",answer:"Yes",choices:["Yes","No","It disappears","It turns to gas"]},{text:"Mixing two materials together is called making a ___.",answer:"Mixture",choices:["Mixture","Solid","Gas","Shadow"]},{text:"If you stir sugar into water until it disappears, has the sugar left forever?",answer:"No, it dissolved",choices:["No, it dissolved","Yes, it's gone","It turned to ice","It became a rock"]}],[{text:"Which state of matter has no definite shape AND no definite volume?",answer:"Gas",choices:["Gas","Solid","Liquid","Rock"]},{text:"Which material property describes if something sinks or floats?",answer:"Density",choices:["Density","Color","Smell","Loudness"]},{text:"Melting and freezing are examples of changes caused by ___.",answer:"Temperature",choices:["Temperature","Color","Sound","Taste"]}]],
  ecosystems_2:[[{text:"A habitat is a place where an animal or plant ___.",answer:"Lives and gets what it needs",choices:["Lives and gets what it needs","Sleeps only","Goes to school","Buys food"]},{text:"Which is an example of a habitat?",answer:"A forest",choices:["A forest","A backpack","A shoe","A car"]},{text:"Why do living things need a habitat?",answer:"To find food, water, and shelter",choices:["To find food, water, and shelter","To watch TV","To play games","To read books"]}],[{text:"Desert plants like cactuses store ___.",answer:"Water",choices:["Water","Ice","Sand","Snow"]},{text:"Plants in a rainforest habitat get lots of ___.",answer:"Rain",choices:["Rain","Snow","Sand","Ice"]},{text:"Why do plants grow differently in different habitats?",answer:"They adapt to that habitat's conditions",choices:["They adapt to that habitat's conditions","They all grow the same","They choose randomly","They copy animals"]}],[{text:"A polar bear's habitat is the ___.",answer:"Arctic",choices:["Arctic","Desert","Rainforest","Ocean floor"]},{text:"A fish's habitat is usually ___.",answer:"Water",choices:["Water","A tree","A cave","The sky"]},{text:"Why can't a polar bear live well in a hot desert?",answer:"It's built for cold, not heat",choices:["It's built for cold, not heat","It doesn't like sand","It's too big","It can't walk"]}],[{text:"Biodiversity means having many different ___ in one place.",answer:"Kinds of living things",choices:["Kinds of living things","Colors of paint","Types of rocks only","Kinds of weather"]},{text:"A habitat with many different plants and animals is ___.",answer:"More biodiverse",choices:["More biodiverse","Empty","Less alive","A desert always"]},{text:"Why is biodiversity important for a habitat?",answer:"It keeps the ecosystem healthy and balanced",choices:["It keeps the ecosystem healthy and balanced","It makes it louder","It makes it colder","It has no effect"]}],[{text:"If a habitat is destroyed, what usually happens to the animals living there?",answer:"They must move or may die out",choices:["They must move or may die out","They turn into plants","Nothing changes","They grow bigger"]},{text:"Which habitat has the LEAST plant life?",answer:"A frozen ice cap",choices:["A frozen ice cap","A rainforest","A grassland","A wetland"]},{text:"Two animals that need the same food in a habitat are said to ___.",answer:"Compete for resources",choices:["Compete for resources","Ignore each other","Always share equally","Never interact"]}]],
  waves_4:[[{text:"A wave carries ___ from one place to another.",answer:"Energy",choices:["Energy","Matter only","Nothing","Color only"]},{text:"Which of these is an example of a wave?",answer:"A ripple in a pond",choices:["A ripple in a pond","A rock","A chair","A tree"]},{text:"Do waves move matter far away, or mostly energy?",answer:"Mostly energy",choices:["Mostly energy","Only matter","Nothing at all","Only heat"]}],[{text:"The height of a wave is called its ___.",answer:"Amplitude",choices:["Amplitude","Wavelength","Frequency","Speed"]},{text:"The distance between two wave peaks is the ___.",answer:"Wavelength",choices:["Wavelength","Amplitude","Volume","Color"]},{text:"A taller wave usually carries ___ energy.",answer:"More",choices:["More","Less","No","Negative"]}],[{text:"Light is a type of ___ wave.",answer:"Electromagnetic",choices:["Electromagnetic","Sound","Water","Ocean"]},{text:"Can light waves travel through empty space?",answer:"Yes",choices:["Yes","No","Only at night","Only underwater"]},{text:"White light is made of ___.",answer:"Many colors",choices:["Many colors","No colors","Only red","Only sound"]}],[{text:"Sound waves need a ___ to travel through.",answer:"Medium (like air or water)",choices:["Medium (like air or water)","Nothing at all","Only light","Only color"]},{text:"Can sound waves travel through empty space (a vacuum)?",answer:"No",choices:["No","Yes","Only loud sounds","Only at night"]},{text:"A higher pitch sound has a ___ frequency.",answer:"Higher",choices:["Higher","Lower","No","Negative"]}],[{text:"Which uses waves to send information over long distances?",answer:"Radio signals",choices:["Radio signals","A rock","A puddle","A blanket"]},{text:"Morse code sending flashes of light is an example of using waves to ___.",answer:"Transmit information",choices:["Transmit information","Cook food","Make ice","Grow plants"]},{text:"Fiber optic cables send information using pulses of ___.",answer:"Light",choices:["Light","Sand","Water","Dirt"]}]],
  rocks_4:[[{text:"Rocks formed from cooled melted lava or magma are ___ rocks.",answer:"Igneous",choices:["Igneous","Sedimentary","Metamorphic","Plastic"]},{text:"Rocks formed from layers of sediment pressed together are ___ rocks.",answer:"Sedimentary",choices:["Sedimentary","Igneous","Metamorphic","Liquid"]},{text:"Rocks changed by heat and pressure over time are ___ rocks.",answer:"Metamorphic",choices:["Metamorphic","Igneous","Sedimentary","Frozen"]}],[{text:"The rock cycle describes how rocks ___ over time.",answer:"Change from one type to another",choices:["Change from one type to another","Stay exactly the same forever","Disappear completely","Turn into animals"]},{text:"What can turn any rock into sediment?",answer:"Weathering and erosion",choices:["Weathering and erosion","Painting","Freezing only","Nothing"]},{text:"Melting a rock and letting it cool can form a new ___ rock.",answer:"Igneous",choices:["Igneous","Sedimentary","Metamorphic","Wooden"]}],[{text:"Weathering is the breaking down of rock by ___.",answer:"Wind, water, or ice",choices:["Wind, water, or ice","Magic","Animals only","Fire only"]},{text:"Erosion is when broken rock pieces are ___.",answer:"Moved to a new place",choices:["Moved to a new place","Created from nothing","Melted instantly","Turned to gas"]},{text:"A river carrying sand and rock downstream is an example of ___.",answer:"Erosion",choices:["Erosion","Evaporation","Condensation","Photosynthesis"]}],[{text:"Fossils are usually found in ___ rock.",answer:"Sedimentary",choices:["Sedimentary","Igneous","Metamorphic","Volcanic"]},{text:"Deeper rock layers are usually ___ than layers above them.",answer:"Older",choices:["Older","Younger","The same age","Made of metal"]},{text:"What can fossils in rock layers tell scientists?",answer:"What lived there long ago",choices:["What lived there long ago","Tomorrow's weather","The rock's color only","Nothing useful"]}],[{text:"Earth's surface changes slowly over time mainly due to ___.",answer:"Weathering, erosion, and other forces",choices:["Weathering, erosion, and other forces","Nothing, it never changes","Only rain in summer","Only animals digging"]},{text:"A canyon like the Grand Canyon was mainly carved by ___.",answer:"A river over millions of years",choices:["A river over millions of years","One big storm","Animals digging","Wind in one day"]},{text:"Which process builds up new land over time from rock and sediment?",answer:"Deposition",choices:["Deposition","Evaporation","Condensation","Combustion"]}]],
  matter_5:[[{text:"All matter is made of tiny particles too small to ___.",answer:"See with the naked eye",choices:["See with the naked eye","Touch ever","Weigh","Smell always"]},{text:"In a solid, particles are ___.",answer:"Tightly packed and vibrate in place",choices:["Tightly packed and vibrate in place","Far apart and moving freely","Not moving at all","Turning into energy"]},{text:"In a gas, particles are ___.",answer:"Far apart and moving freely",choices:["Far apart and moving freely","Tightly packed","Frozen still","Glued together"]}],[{text:"Which state of matter has a definite shape and volume?",answer:"Solid",choices:["Solid","Liquid","Gas","Plasma only"]},{text:"Which state of matter takes the shape of its container but keeps its volume?",answer:"Liquid",choices:["Liquid","Solid","Gas","None"]},{text:"Which state of matter has no definite shape or volume?",answer:"Gas",choices:["Gas","Solid","Liquid","Rock"]}],[{text:"When you break a rock into pieces, the total ___ stays the same.",answer:"Mass",choices:["Mass","Color","Shape","Smell"]},{text:"The law of conservation of matter says matter cannot be ___ in ordinary changes.",answer:"Created or destroyed",choices:["Created or destroyed","Colored","Touched","Weighed"]},{text:"If you melt an ice cube, is its mass the same before and after?",answer:"Yes, mass stays the same",choices:["Yes, mass stays the same","No, it disappears","No, it doubles","It becomes zero"]}],[{text:"Cutting paper into pieces is an example of a ___ change.",answer:"Physical",choices:["Physical","Chemical","Nuclear","Impossible"]},{text:"In a physical change, does the matter turn into a new substance?",answer:"No, it stays the same substance",choices:["No, it stays the same substance","Yes, always a new substance","Yes, it disappears","It becomes energy only"]},{text:"Which is a physical change?",answer:"Melting butter",choices:["Melting butter","Burning wood","Rusting iron","Baking a cake"]}],[{text:"Which is a sign that a chemical change happened?",answer:"A new substance forms (like gas bubbles or color change)",choices:["A new substance forms (like gas bubbles or color change)","The object gets cut smaller","The object changes shape only","The object gets colder only"]},{text:"Rusting of iron is an example of a ___ change.",answer:"Chemical",choices:["Chemical","Physical","Temporary","Reversible easily"]},{text:"Burning wood into ash and smoke is a ___ change.",answer:"Chemical",choices:["Chemical","Physical","Magnetic","Electrical"]}]],
  ecosystems_5:[[{text:"A food web shows how ___ are connected through what they eat.",answer:"Many organisms",choices:["Many organisms","Only plants","Only rocks","Only weather"]},{text:"In a food web, producers make their own food using ___.",answer:"Sunlight (photosynthesis)",choices:["Sunlight (photosynthesis)","Other animals","Rocks","Rain only"]},{text:"An animal that eats only plants is called a ___.",answer:"Herbivore",choices:["Herbivore","Carnivore","Omnivore","Decomposer"]}],[{text:"The water cycle includes evaporation, condensation, and ___.",answer:"Precipitation",choices:["Precipitation","Combustion","Photosynthesis","Erosion"]},{text:"Decomposers help matter cycle by ___.",answer:"Breaking down dead plants and animals",choices:["Breaking down dead plants and animals","Eating only sunlight","Creating new rocks","Making rain"]},{text:"Carbon moves between air, plants, and animals in the ___.",answer:"Carbon cycle",choices:["Carbon cycle","Rock cycle","Money cycle","Light cycle"]}],[{text:"The layer of air around Earth is the ___.",answer:"Atmosphere",choices:["Atmosphere","Hydrosphere","Geosphere","Biosphere"]},{text:"All the water on Earth makes up the ___.",answer:"Hydrosphere",choices:["Hydrosphere","Atmosphere","Geosphere","Biosphere"]},{text:"All living things on Earth make up the ___.",answer:"Biosphere",choices:["Biosphere","Atmosphere","Hydrosphere","Geosphere"]}],[{text:"Cutting down large areas of forest is called ___.",answer:"Deforestation",choices:["Deforestation","Conservation","Precipitation","Photosynthesis"]},{text:"Which human activity can pollute rivers and oceans?",answer:"Dumping waste into water",choices:["Dumping waste into water","Planting trees","Recycling","Using less water"]},{text:"How can humans reduce their negative impact on ecosystems?",answer:"Conserve resources and reduce pollution",choices:["Conserve resources and reduce pollution","Use more plastic","Cut down more forests","Waste more water"]}],[{text:"A protected area set aside to conserve nature is called a ___.",answer:"Nature reserve",choices:["Nature reserve","Shopping mall","Parking lot","Factory"]},{text:"Recycling helps ecosystems by ___.",answer:"Reducing waste and pollution",choices:["Reducing waste and pollution","Making more trash","Using more new resources","Polluting rivers"]},{text:"Why is protecting biodiversity important for ecosystems?",answer:"It keeps ecosystems stable and healthy",choices:["It keeps ecosystems stable and healthy","It makes ecosystems weaker","It has no real effect","It only helps humans"]}]],
};
...
const READING_QS = {
  ...
  sight_1:[[{text:"Which word completes: 'I ___ a dog.'",answer:"have",choices:["have","jump","purple","seven"]},{text:"Which word completes: 'The ball is ___ me.'",answer:"for",choices:["for","running","yellow","tomorrow"]},{text:"Which word means the opposite of 'go'?",answer:"stop",choices:["stop","and","the","said"]}],[{text:"Which word completes: 'We ___ to the park.'",answer:"went",choices:["went","purple","seven","jumping"]},{text:"Which word completes: 'This ___ my book.'",answer:"is",choices:["is","running","yellow","tomorrow"]},{text:"Which word completes: 'Can you help ___?'",answer:"me",choices:["me","jumping","seven","purple"]}],[{text:"Which word completes: 'They ___ playing outside.'",answer:"were",choices:["were","purple","seven","fastest"]},{text:"Which word completes: '___ you like ice cream?'",answer:"Do",choices:["Do","Jumping","Yellow","Seven"]},{text:"Which word completes: 'She looked ___ the window.'",answer:"out",choices:["out","purple","seven","jumping"]}],[{text:"Which word completes: 'I ___ never seen that before.'",answer:"have",choices:["have","purple","running","seven"]},{text:"Which word completes: 'Put it ___ the table.'",answer:"under",choices:["under","purple","jumping","seven"]},{text:"Which word completes: 'We should go ___ home.'",answer:"back",choices:["back","purple","seven","jumping"]}],[{text:"Which word completes: 'It happened ___ they arrived.'",answer:"before",choices:["before","purple","seven","jumping"]},{text:"Which word completes: 'That was ___ than I expected.'",answer:"different",choices:["different","purple","seven","jumping"]},{text:"Which word completes: 'Everyone ___ their own opinion.'",answer:"has",choices:["has","purple","seven","jumping"]}]],
  phonics_2:[[{text:"Which word has a short 'a' sound?",answer:"cat",choices:["cat","cake","rain","play"]},{text:"Which word has a short 'e' sound?",answer:"bed",choices:["bed","bee","seat","tree"]},{text:"Which word has a short 'i' sound?",answer:"pig",choices:["pig","pie","kite","light"]}],[{text:"Which word has a long 'a' sound?",answer:"cake",choices:["cake","cat","hat","bag"]},{text:"Which word has a long 'e' sound?",answer:"tree",choices:["tree","bed","pen","red"]},{text:"Which word has a long 'o' sound?",answer:"boat",choices:["boat","hot","dog","box"]}],[{text:"Which word starts with the blend 'bl'?",answer:"blue",choices:["blue","tap","sun","dog"]},{text:"Which word has the digraph 'sh'?",answer:"ship",choices:["ship","stop","top","sat"]},{text:"Which word has the digraph 'ch'?",answer:"chip",choices:["chip","cap","top","sit"]}],[{text:"Which word has the vowel team 'ai'?",answer:"rain",choices:["rain","run","red","rock"]},{text:"Which word has the vowel team 'oa'?",answer:"boat",choices:["boat","bat","bet","but"]},{text:"Which word has the vowel team 'ee'?",answer:"feet",choices:["feet","fat","fit","fun"]}],[{text:"How many syllables are in 'elephant'?",answer:"3",choices:["3","1","2","5"]},{text:"How many syllables are in 'butterfly'?",answer:"3",choices:["3","2","1","4"]},{text:"How many syllables are in 'computer'?",answer:"3",choices:["3","2","4","1"]}]],
  vocab_4:[[{text:"The Greek root 'photo' means ___.",answer:"Light",choices:["Light","Water","Fire","Sound"]},{text:"The Greek root 'graph' means ___.",answer:"Write or draw",choices:["Write or draw","Run","Jump","Sleep"]},{text:"The Greek root 'bio' means ___.",answer:"Life",choices:["Life","Death","Water","Sky"]}],[{text:"The Latin root 'dict' means ___.",answer:"To say or speak",choices:["To say or speak","To run","To eat","To build"]},{text:"The Latin root 'port' means ___.",answer:"To carry",choices:["To carry","To sing","To sleep","To draw"]},{text:"The Latin root 'spect' means ___.",answer:"To look or see",choices:["To look or see","To hear","To taste","To smell"]}],[{text:"'It's raining cats and dogs' means ___.",answer:"It's raining very hard",choices:["It's raining very hard","Animals are falling","It's a sunny day","Pets are outside"]},{text:"'Break the ice' means ___.",answer:"Ease tension in a social situation",choices:["Ease tension in a social situation","Literally break ice","Get very cold","Skate on a pond"]},{text:"'Piece of cake' means ___.",answer:"Something very easy",choices:["Something very easy","A dessert recipe","Something very hard","A type of bread"]}],[{text:"'The early bird catches the worm' means ___.",answer:"Acting early leads to success",choices:["Acting early leads to success","Birds like worms","Sleep in every day","Worms are fast"]},{text:"'Don't judge a book by its cover' means ___.",answer:"Don't judge something by appearance alone",choices:["Don't judge something by appearance alone","Books need nice covers","Always read the summary","Covers don't matter at all"]},{text:"'Actions speak louder than words' means ___.",answer:"What you do matters more than what you say",choices:["What you do matters more than what you say","Talking loudly is rude","Actions make noise","Words are unimportant"]}],[{text:"In science, a 'hypothesis' is ___.",answer:"An educated guess to be tested",choices:["An educated guess to be tested","A proven fact","A type of experiment tool","A science teacher"]},{text:"In math, a 'variable' is ___.",answer:"A symbol representing an unknown value",choices:["A symbol representing an unknown value","A type of graph","A fixed number","A math teacher"]},{text:"In social studies, a 'citizen' is ___.",answer:"A legal member of a country",choices:["A legal member of a country","A type of government","A city building","A law"]}]],
  inform_text_4:[[{text:"A text organized by 'first, next, then, finally' uses ___ structure.",answer:"Sequence",choices:["Sequence","Compare and contrast","Cause and effect","Problem and solution"]},{text:"A text that explains why something happened uses ___ structure.",answer:"Cause and effect",choices:["Cause and effect","Sequence","Description","Compare and contrast"]},{text:"A text that shows how two things are alike and different uses ___ structure.",answer:"Compare and contrast",choices:["Compare and contrast","Sequence","Cause and effect","Problem and solution"]}],[{text:"A text written using 'I' and 'we' is in ___ point of view.",answer:"First person",choices:["First person","Third person","Second person","No person"]},{text:"A text written using 'he,' 'she,' and 'they' is in ___ point of view.",answer:"Third person",choices:["Third person","First person","Second person","No person"]},{text:"Point of view tells you ___.",answer:"Who is telling the story or information",choices:["Who is telling the story or information","The page number","The title only","The publisher"]}],[{text:"A good summary should be ___ than the original text.",answer:"Much shorter",choices:["Much shorter","Much longer","The exact same length","Twice as long"]},{text:"A summary should include ___.",answer:"Only the most important ideas",choices:["Only the most important ideas","Every single detail","Your personal opinion","Made-up information"]},{text:"Why do we summarize a text?",answer:"To capture the main points briefly",choices:["To capture the main points briefly","To make it longer","To add new facts","To confuse the reader"]}],[{text:"A strong argument is usually supported by ___.",answer:"Evidence and facts",choices:["Evidence and facts","Only feelings","Guessing","Nothing at all"]},{text:"An opinion stated without evidence is a ___ argument.",answer:"Weak",choices:["Weak","Strong","Perfect","Scientific"]},{text:"What should you ask when evaluating an argument?",answer:"Is this claim supported by evidence?",choices:["Is this claim supported by evidence?","Is this the longest sentence?","Does this use big words?","Is this written in cursive?"]}],[{text:"When comparing two texts on the same topic, you look for ___.",answer:"Similarities and differences",choices:["Similarities and differences","Only the page count","Only the author's age","Only the font used"]},{text:"Two texts can have the same topic but different ___.",answer:"Points of view or purposes",choices:["Points of view or purposes","Page numbers","Fonts","Margins"]},{text:"Comparing texts helps readers understand ___.",answer:"Different perspectives on a topic",choices:["Different perspectives on a topic","Nothing useful","Only spelling rules","Only grammar rules"]}]],
  word_study_5:[[{text:"'Slender' and 'skinny' both describe thinness, but 'slender' has a more ___ connotation.",answer:"Positive",choices:["Positive","Negative","Angry","Confusing"]},{text:"Which word has a negative connotation for 'curious'?",answer:"Nosy",choices:["Nosy","Inquisitive","Interested","Curious"]},{text:"Connotation refers to a word's ___.",answer:"Emotional feeling or association",choices:["Emotional feeling or association","Exact dictionary definition","Number of letters","Spelling pattern"]}],[{text:"In a science text, 'evaporation' specifically means ___.",answer:"Liquid changing into gas",choices:["Liquid changing into gas","Gas changing into liquid","Solid changing into liquid","Ice forming"]},{text:"In math, 'sum' specifically means the result of ___.",answer:"Addition",choices:["Addition","Subtraction","Multiplication","Division"]},{text:"Technical vocabulary is language that is ___.",answer:"Specific to a subject or field",choices:["Specific to a subject or field","Used only in casual talk","Always slang","Never used in school"]}],[{text:"'Happy' and 'joyful' are ___.",answer:"Synonyms",choices:["Synonyms","Antonyms","Homophones","Unrelated"]},{text:"'Hot' and 'cold' are ___.",answer:"Antonyms",choices:["Antonyms","Synonyms","Homophones","The same word"]},{text:"'Flower' and 'flour' are ___.",answer:"Homophones",choices:["Homophones","Synonyms","Antonyms","Prefixes"]}],[{text:"'The wind whispered through the trees' is an example of ___.",answer:"Personification",choices:["Personification","A simile","An idiom","A fact"]},{text:"'As brave as a lion' is an example of a ___.",answer:"Simile",choices:["Simile","Metaphor","Idiom","Fact"]},{text:"'Time is money' is an example of a ___.",answer:"Metaphor",choices:["Metaphor","Simile","Personification","Literal statement"]}],[{text:"Etymology is the study of a word's ___.",answer:"Origin and history",choices:["Origin and history","Spelling only","Length","Pronunciation only"]},{text:"Many English science words come from Greek and ___.",answer:"Latin",choices:["Latin","French","German","Spanish"]},{text:"Knowing a word's etymology can help you ___.",answer:"Understand its meaning",choices:["Understand its meaning","Ignore it","Forget it faster","Mispronounce it"]}]],
};
...
const GEO_QS = {
  ...
  maps_1:[[{text:"Which direction is opposite of North?",answer:"South",choices:["South","East","West","Up"]},{text:"Which direction is opposite of East?",answer:"West",choices:["West","North","South","Down"]},{text:"On most maps, which direction points up?",answer:"North",choices:["North","South","East","West"]}],[{text:"A map is a picture that shows ___.",answer:"Where places are",choices:["Where places are","The weather tomorrow","A story","A song"]},{text:"What does a map key (legend) help you do?",answer:"Understand what map symbols mean",choices:["Understand what map symbols mean","Tell time","Cook food","Draw pictures"]},{text:"On a map, a blue line usually shows a ___.",answer:"River",choices:["River","Road","Mountain","Desert"]}],[{text:"A small picture on a map that stands for something real is called a ___.",answer:"Symbol",choices:["Symbol","Song","Story","Sentence"]},{text:"A tiny airplane symbol on a map usually shows a(n) ___.",answer:"Airport",choices:["Airport","Farm","Lake","Mountain"]},{text:"A star symbol on a map often shows a ___.",answer:"Capital city",choices:["Capital city","River","Ocean","Forest"]}],[{text:"A neighborhood is ___.",answer:"The area around where you live",choices:["The area around where you live","A different country","A type of food","A season"]},{text:"Which of these might you find in a neighborhood map?",answer:"Streets and houses",choices:["Streets and houses","Ocean currents","Mountain ranges only","Countries"]},{text:"Why is it helpful to know your way around your neighborhood?",answer:"So you can find places safely",choices:["So you can find places safely","So you can fly a plane","So you can swim faster","So you can cook dinner"]}],[{text:"A community includes people who ___.",answer:"Live and work in the same area",choices:["Live and work in the same area","Never see each other","Live on different planets","All have the same job"]},{text:"Which is an important place in most communities?",answer:"A school",choices:["A school","A volcano","A desert","An ocean"]},{text:"A map of your community would show ___.",answer:"Local streets, buildings, and parks",choices:["Local streets, buildings, and parks","Other planets","The whole world","Ancient history"]}]],
  landforms_2:[[{text:"A mountain is a very ___ landform.",answer:"Tall",choices:["Tall","Flat","Wet","Small"]},{text:"A valley is usually found ___ mountains.",answer:"Between",choices:["Between","On top of","Under the ocean","In the sky"]},{text:"Which is the tallest landform?",answer:"A mountain",choices:["A mountain","A plain","A valley","A plateau"]}],[{text:"A plain is a large area of ___ land.",answer:"Flat",choices:["Flat","Very tall","Underwater","Icy"]},{text:"A plateau is a flat area of land that is ___.",answer:"Raised high above the surrounding land",choices:["Raised high above the surrounding land","Underwater","The lowest point on Earth","Always frozen"]},{text:"Farmers often grow crops on ___ because the land is flat.",answer:"Plains",choices:["Plains","Mountain peaks","Ocean floors","Glaciers"]}],[{text:"A river is a ___ body of moving water.",answer:"Long, flowing",choices:["Long, flowing","Still, round","Salty, huge","Frozen, solid"]},{text:"A lake is usually a body of water ___ by land.",answer:"Surrounded",choices:["Surrounded","Never touched","Covered in sand","Made of ice"]},{text:"Rivers usually flow toward a ___.",answer:"Larger body of water like a lake or ocean",choices:["Larger body of water like a lake or ocean","Mountain top","Desert only","Cloud"]}],[{text:"An ocean is a ___ body of salt water.",answer:"Huge",choices:["Huge","Tiny","Frozen solid","Man-made"]},{text:"A bay is a body of water partly ___ by land.",answer:"Surrounded",choices:["Surrounded","Never touched","Frozen","Underground"]},{text:"Which is the largest type of body of water?",answer:"An ocean",choices:["An ocean","A pond","A stream","A puddle"]}],[{text:"An island is land completely surrounded by ___.",answer:"Water",choices:["Water","Mountains","Desert","Ice only"]},{text:"A peninsula is land surrounded by water on ___ sides.",answer:"Three",choices:["Three","One","All four","Zero"]},{text:"Which landform is formed mainly by flowing water cutting through rock over time?",answer:"A canyon",choices:["A canyon","A plain","A plateau","An island"]}]],
  world_geo_4:[[{text:"Which country is in North America and borders the United States to the north?",answer:"Canada",choices:["Canada","Brazil","France","Egypt"]},{text:"What is the capital of Mexico?",answer:"Mexico City",choices:["Mexico City","Cancun","Guadalajara","Tijuana"]},{text:"Which large country makes up most of South America's Amazon rainforest?",answer:"Brazil",choices:["Brazil","Canada","Mexico","Argentina"]}],[{text:"What is the capital of France?",answer:"Paris",choices:["Paris","London","Rome","Berlin"]},{text:"What is the capital of Italy?",answer:"Rome",choices:["Rome","Paris","Madrid","Berlin"]},{text:"What is the capital of Germany?",answer:"Berlin",choices:["Berlin","Paris","Rome","London"]}],[{text:"What is the capital of Japan?",answer:"Tokyo",choices:["Tokyo","Beijing","Seoul","Bangkok"]},{text:"What is the capital of China?",answer:"Beijing",choices:["Beijing","Tokyo","Delhi","Hanoi"]},{text:"Which country has the largest population in the world (as of recent data)?",answer:"India",choices:["India","Japan","France","Canada"]}],[{text:"What is the capital of Egypt?",answer:"Cairo",choices:["Cairo","Lagos","Nairobi","Casablanca"]},{text:"Which is the largest desert in Africa?",answer:"The Sahara",choices:["The Sahara","The Gobi","The Mojave","The Arctic"]},{text:"Which African country is known for the pyramids of Giza?",answer:"Egypt",choices:["Egypt","Kenya","Nigeria","Morocco"]}],[{text:"What is the capital of Australia?",answer:"Canberra",choices:["Canberra","Sydney","Melbourne","Perth"]},{text:"What is the capital of Russia?",answer:"Moscow",choices:["Moscow","St. Petersburg","Kiev","Warsaw"]},{text:"What is the capital of Brazil?",answer:"Brasília",choices:["Brasília","Rio de Janeiro","São Paulo","Lima"]}]],
  climate_4:[[{text:"Earth's three main climate zones are polar, temperate, and ___.",answer:"Tropical",choices:["Tropical","Frozen","Volcanic","Underground"]},{text:"Which climate zone is closest to the equator?",answer:"Tropical",choices:["Tropical","Polar","Temperate","Arctic"]},{text:"Which climate zone has the coldest temperatures?",answer:"Polar",choices:["Polar","Tropical","Temperate","Equatorial"]}],[{text:"Tropical rainforests get a large amount of ___.",answer:"Rainfall",choices:["Rainfall","Snow","Ice","Sand"]},{text:"Tropical rainforests are known for having very high ___.",answer:"Biodiversity",choices:["Biodiversity","Snowfall","Elevation only","Ice coverage"]},{text:"Temperatures in tropical biomes are usually ___ year-round.",answer:"Warm",choices:["Warm","Freezing","Below zero","Snowy"]}],[{text:"Deserts receive very little ___.",answer:"Rainfall",choices:["Rainfall","Sunlight","Sand","Wind"]},{text:"Which biome is known for hot days and cold nights?",answer:"Desert",choices:["Desert","Rainforest","Tundra","Wetland"]},{text:"Which adaptation helps desert plants like cacti survive?",answer:"Storing water",choices:["Storing water","Growing tall for shade","Living underwater","Needing daily rain"]}],[{text:"A forest with trees that lose their leaves in fall is a ___ forest.",answer:"Deciduous",choices:["Deciduous","Tropical","Coniferous","Desert"]},{text:"A forest with mostly needle-leaved evergreen trees is a ___ forest.",answer:"Coniferous",choices:["Coniferous","Deciduous","Desert","Tundra"]},{text:"Forests are important because they produce a lot of Earth's ___.",answer:"Oxygen",choices:["Oxygen","Sand","Salt water","Ice"]}],[{text:"Polar biomes are found near Earth's ___.",answer:"North and South Poles",choices:["North and South Poles","Equator","Middle latitudes","Ocean floor only"]},{text:"The frozen, treeless polar biome is called the ___.",answer:"Tundra",choices:["Tundra","Rainforest","Savanna","Desert"]},{text:"Animals in polar biomes often have thick fur or blubber to ___.",answer:"Stay warm",choices:["Stay warm","Swim faster","See better","Climb trees"]}]],
  econ_5:[[{text:"A natural resource is something ___ that people use.",answer:"From nature",choices:["From nature","Made in a factory","Invented by scientists","Drawn on paper"]},{text:"Which is an example of a natural resource?",answer:"Fresh water",choices:["Fresh water","A video game","A car","A computer"]},{text:"Countries with lots of oil often use it to ___.",answer:"Trade and earn money",choices:["Trade and earn money","Paint their flags","Grow crops only","Build snowmen"]}],[{text:"A trade route is a path used to ___ goods between places.",answer:"Move and exchange",choices:["Move and exchange","Hide","Destroy","Ignore"]},{text:"The Silk Road was a famous trade route connecting ___.",answer:"Asia and Europe",choices:["Asia and Europe","North and South Pole","The Moon and Earth","Two small towns"]},{text:"Why did ancient trade routes often follow rivers and coastlines?",answer:"Water made transporting goods easier",choices:["Water made transporting goods easier","Rivers taste good","There was no land available","Coastlines are colder"]}],[{text:"Cultural geography studies how ___ relate to the places they live.",answer:"People and their cultures",choices:["People and their cultures","Only rocks","Only weather","Only animals"]},{text:"Language, religion, and traditions are all parts of a group's ___.",answer:"Culture",choices:["Culture","Climate","Landform","Currency"]},{text:"Why might people in a mountain region have different traditions than people near the coast?",answer:"Their environment shapes how they live",choices:["Their environment shapes how they live","They speak the exact same way always","Geography has no effect on culture","Mountains and coasts are identical"]}],[{text:"Physical geography studies natural features like mountains and rivers, while human geography studies ___.",answer:"People and their activities",choices:["People and their activities","Only rocks","Only oceans","Only weather"]},{text:"Building a city near a river is an example of humans adapting to ___ geography.",answer:"Physical",choices:["Physical","Cultural","Political","Digital"]},{text:"Which is a human-made feature on a map?",answer:"A highway",choices:["A highway","A mountain","A river","An ocean"]}],[{text:"Globalization means countries around the world are becoming more ___.",answer:"Connected through trade and communication",choices:["Connected through trade and communication","Isolated from each other","Identical in culture","Unaware of each other"]},{text:"A product made from parts sourced in several countries shows ___.",answer:"A global supply chain",choices:["A global supply chain","A single farm","A local-only market","A closed economy"]},{text:"Why do countries trade with each other?",answer:"To get resources or goods they don't have enough of",choices:["To get resources or goods they don't have enough of","To avoid all contact","Because it's required by weather","To make maps"]}]],
};
...
export default function Clariva() {
  ...
  const startQuiz=(unit,levelIdx)=>{
    // Avoid showing the exact same question back-to-back within a quiz. Curated
    // question banks only have ~3 questions per level (by design — math generates
    // infinite variety, but trivia-style subjects don't), so a 10-question quiz was
    // always going to cycle through a small pool; the bug was landing on the SAME
    // question 2-3x in a row purely by chance. Only guard against immediate repeats.
    let prevText=null;
    const qs=Array.from({length:TOTAL_Q},()=>{
      let q,tries=0;
      do{ q=generateQuestion(activeSubject.id,unit,levelIdx); tries++; }
      while(q.text===prevText&&tries<25);
      prevText=q.text;
      return q;
    });
